...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/davidcjw",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/davidcjw",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Email",
    href: "mailto:davidcjw@gmail.com",
    icon: (
...
export default function Footer() {
  return (
    <footer id="contact" className="bg-gray-900 border-t border-white/5 py-16 px-6">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-8">
        ...
        >
          {socials.map(({ label, href, icon }) => (
            <a
              ...
              aria-label={label}
              className="flex items-center justify-center w-10 h-10 rounded-full border border-white/10 text-gray-400 hover:text-white hover:border-indigo-500/50 hover:bg-indigo-950/40 transition-all"
            >
              {icon}
            </a>
          ))}
        ...
        <p className="text-gray-600 text-xs">
          © {new Date().getFullYear()} David Chong
        </p>
      </div>
    </footer>
  );
